...
✅ RESOLVED – The double-write bug has been fixed by retaining REVM changes in the overlay until the end of block and by persisting contract byte-code during `flushPending()`.

The original description is kept below for historical reference.
